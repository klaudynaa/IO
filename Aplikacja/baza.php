<?php 
$bd = mysql_connect('mysql.cba.pl', 'klaudynna', 'Erkaka1391');
...
$prevLink = $_SERVER['index.php?strona=6'] . '?page=' . $prev;
$nextLink = $_SERVER['index.php?strona=6'] . '?page=' . $next;
...
///..................numery stron
			for($i=0; $i<$max; $i++)
			{
				...
				//$start_tmp=$i*$perPage;
				$start_tmp=$i+1;
				echo " <a href=index.php?strona=6&page=$start_tmp>$y</a>";
				if(($i!=$max)-1)
				echo" |";
			}
				?>			