...
if (!$bd) {
	  exit('<p>Nie mo�na skontaktowa� si� ' .
...
if(isset($_POST["wyslij"]))
{
	...
	{ 
      ...
      if(preg_match('/^[a-zA-Z0-9\.\-\_]+\@[a-zA-Z0-9\.\-\_]+\.[a-z]{2,4}$/D', $_POST["email"]) && preg_match('/^[0-9]{2}+\-[0-9]{3}$/D', $_POST["kod_p"]))
      {
	            ...
	            else if(preg_match('/^[a-zA-Z0-9\.\-\_]+\@[a-zA-Z0-9\.\-\_]+\.[a-z]{2,4}$/D', $_POST["email"]) && !(preg_match('/^[0-9]{2}+\-[0-9]{3}$/D', $_POST["kod_p"])))
	            {
	            	echo (' <form action="index.php?strona=7&id='.$_GET['id'].'" method="post">
						<table> 
							...
							<tr> 
								...
								'); 
									  ...
									  { 
											echo(' 
									  <td> 
									  <input type="radio" name="plec" value="Mężczyzna"/> M?zyzna  <br/>
									   <input type="radio" name="plec" value="Kobieta"checked/> Kobieta <br/>
									   </td> 
									  '); 
									  } 
							...
							<tr>
							<td align="left"> nazwisko panie??e: </td>
							<td><input type="text" value="'.$naz_pan.'" name="naz_pan"/></td> 
							</tr>
							...
							<tr>
							<td align="center">
							<td> <input type="submit" value="wy?ij" name="wyslij"/> </td>
							</td>
	                      	...
	                      	echo("Pola formularza zawiera? nieprawid?wy kod pocztowy.");
						...
						<table> 
							...
							<tr> 
                                    ...
                                    '); 
                                          ...
                                          echo(' 
                                          <td> 
                                          <input type="radio" name="plec" value="M?zyzna"checked/> M?zyzna  <br/>
                                           <input type="radio" name="plec" value="Kobieta"/> Kobieta <br/>
                                           </td> 
                                          '); 
                                          } 
							...
							<td> <input type="submit" value="wy?ij" name="wyslij"/> </td>
	                      	...
	                      	echo("Pola formularza zawiera? nieprawid?wy adres email i kod pocztowy.");
		...
		//Nie wypelniono wszystkich p??        else
		{
						...
						<tr> 
							...
							'); 
								  ...
								  { 
										echo(' 
								  <td> 
								  <input type="radio" name="plec" value="M?zyzna"/> M?zyzna  <br/>
								   <input type="radio" name="plec" value="Kobieta"checked/> Kobieta <br/>
								   </td> 
								  '); 
								  } 
        ...
        echo("Nie wype?iono wszystkich pól");
        }
    } 
else{
		...
		<table> 
			...
			<tr> 
				...
				'); 
					  ...
					  echo(' 
					  <td> 
					  <input type="radio" name="plec" value="M?zyzna" value="'.$plec2.'" checked/> M?zyzna  <br/>
					   <input type="radio" name="plec" value="Kobieta"/> Kobieta <br/>
					   </td> 
					  '); 
					  } 
			...
			<tr>
			<td align="left">
			<td> <input type="submit" value="wy?ij" name="wyslij"/><input type="submit" value="anuluj" name="anuluj"/> </td>
			</td>
